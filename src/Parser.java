...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\010\000\006\003\006\005\004\001\002\000\006\002" +
    "\ufffd\004\011\001\002\000\004\002\010\001\002\000\004" +
    "\002\uffff\001\002\000\004\002\000\001\002\000\004\002" +
    "\001\001\002\000\004\006\012\001\002\000\004\002\ufffe" +
    "\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\010\000\006\002\004\003\006\001\001\000\002\001" +
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
    ...
    System.err.println("❌ Comando inválido. No se ejecutó ninguna acción.");
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // comando ::= COMANDO TEXTO NUMERO 
            {
              Object RESULT =null;
    ...
    if (T.equals("agregar")) {
        System.out.println("🛒 Agregando " + X + " con cantidad " + N);
        Inventario.agregarProducto(X, N.intValue());
    } else if (T.equals("vender")) {
        System.out.println("Se vende " + X + " con el precio " + N);
        Inventario.venderProducto(X, N.intValue());
    }
      ...
      if (T.equals("mostrar_inventario")) {
          System.out.println("📦 Mostrando inventario...");
          Inventario.mostrarInventario();
      } else if (T.equals("generar_reporte")) {
